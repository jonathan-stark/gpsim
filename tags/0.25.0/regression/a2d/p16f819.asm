...
RESET_VECTOR  CODE    0x000              ; processor reset vector
  ...
  .assert "\"FAILED 16F819 a2d unexpected interupt\""
	nop
	goto	check
...
start:
  ...
  .assert "adresh == 0xff, \"Failed 16F819 a2d initial test\""
	nop
  ...
  .assert "adresh == 0x00, \"Failed 16F819 a2d Digital low\""
	nop
  ...
  .assert "adresh == 0xff, \"Failed 16F819 a2d Digital high\""
	nop
	;;
  ...
  .assert "adresh == 0xff, \"Failed 16F819 a2d AN0=5V\""
	nop
  ...
  .assert "adresh == 0x33, \"Failed 16F819 a2d AN0=1V\""
	nop
	;;
  ...
  .command "V2.voltage=2.0"
	...
	call	Convert
  .assert "adresh == 0x80, \"Failed 16F819 a2d AN0=1V Vref+=2V\""
	nop

  .assert  "\"*** PASSED 16F819 a2d test\""
