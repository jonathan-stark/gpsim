...
.command macro x
  ...
  endm
	...
	__CONFIG _CP_OFF & _DEBUG_OFF & _WRT_OFF & _CPD_OFF  & _LVP_OFF  & _PWRTE_ON &  _WDT_OFF & _HS_OSC
...
start	
  ...
  .assert "\"*** PASSED p16f883 I2C test\""
	goto $
...
ProgInit
	...
	banksel SSPADD
	movlw	0xff
	movwf	SSPADD			; sspadd should be masked by SSPMSK
