	...
	list	p=16f883
        ...
        __CONFIG  _CONFIG1, _CP_OFF & _WDT_OFF &  _INTRC_OSC_NOCLKOUT & _PWRTE_ON & _LVP_OFF &  _MCLRE_OFF
        __CONFIG    _CONFIG2, _IESO_OFF & _FCMEN_OFF

	;; The purpose of this program is to test gpsim's ability to simulate a pic 16F883.
	;; Specifically, I2C
...
;
  ...
  .assert "\"*** PASSED p16f883 I2C slave test \""
    nop
