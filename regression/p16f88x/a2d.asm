...
check:  bsf	t1,0		;Set a flag to indicate we got the int.
...
start:
   ...
   .sim "attach na3 V2.pin porta3"
	...
	call	Convert
   .assert "adresh == 0xff, \"FAILED 16F882 inital test\""
	nop
  ...
  .assert "adcon1 == 0xb0, \"FAILED 16F882 invalid ADCON1 bits writable\""
	nop
  ...
  .assert "adresh == 0x00, \"FAILED 16F882 Digital low\""
	nop
  ...
  .assert "adresh == 0xff, \"FAILED 16F882 Digital high\""
	nop
	;;
  ...
  .assert "adresh == 0xff, \"FAILED 16F882 AN1=5V\""
	nop
  ...
  .command "V1.voltage=1.0"
   ...
   .assert "adresh == 0x33, \"FAILED 16F882 AN1=1V\""
	nop
  ...
  .command "V2.voltage=2.0"
   ...
   .assert "adresh == 0x80, \"FAILED 16F882 AN1=1V Vref+=2V\""
	nop
   ...
   .assert "adresh == 0x02, \"FAILED 16F882 ADFM=1 AN1=1V Vref+=2V\""
	nop

  .assert  "\"*** PASSED 16F882 a2d test\""
