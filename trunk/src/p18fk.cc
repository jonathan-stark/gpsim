    ...
    ssp1(this)
{
  ...
  if(verbose)
    cout << "18F14K22 constructor, type = " << isa() << '\n';
...
void P18F14K22::osc_mode(unsigned int value)
{
...
Processor * P18F14K22::construct(const char *name)
{
  ...
  if(verbose&2)
    cout << " 18F14K22 construct completed\n";
  return p;
}
