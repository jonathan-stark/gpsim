...
bool P16F91X::set_config_word(unsigned int address, unsigned int cfg_word)
{
  enum {
    CFG_FOSC0 = 1<<0,
    CFG_FOSC1 = 1<<1,
...
void P16F91X_40::set_out_of_range_pm(unsigned int address, unsigned int value)
{
...
{
  if(verbose)
    cout << "creating f91X_40 registers \n";
...
void P16F91X_40::create_symbols()
{
    P16F91X::create_symbols();
    addSymbol(m_portd);
    addSymbol(m_trisd);
}
...
{
  if(verbose)
    cout << "f91X_40 constructor, type = " << isa() << '\n';
...
void P16F91X_28::set_out_of_range_pm(unsigned int address, unsigned int value)
{
...
{
  if(verbose)
    cout << "creating f91X_28 registers \n";
...
void P16F91X_28::create_symbols()
{
    P16F91X::create_symbols();
}
...
{
  if(verbose)
    cout << "f91X_28 constructor, type = " << isa() << '\n';
...
void P16F917::create_symbols()
{

  if(verbose)
    cout << "f917 create symbols\n";
