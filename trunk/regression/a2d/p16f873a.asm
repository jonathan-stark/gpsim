...
start:
  ...
  .assert "adres == 0xff, \"FAILED 16F873a initial test\""
	nop
  ...
  .assert "adres == 0x00, \"FAILED 16F873a digital low\""
	nop
	;;
  ...
  .assert "adres == 0xff, \"FAILED 16F873a digital high\""
	nop
	;;
  ...
  .assert "adres == 0xff, \"FAILED 16F873a AN0=5V\""
	nop

  .command "V1.voltage=1.0"

	call	Convert
  .assert "adres == 0x33, \"FAILED 16F873a AN0=1V\""
	nop
  ...
  .assert "adres == 0x80, \"FAILED 16F873a AN0=1V Vref+=2V\""
	nop
