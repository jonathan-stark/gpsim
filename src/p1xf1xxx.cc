...
void APFCON2::put(unsigned int new_value)
{
    unsigned int old_value = value.get();
    unsigned int diff = (new_value ^ old_value) & mValidBits;
...
void P16F1503::create_sfr_map()
{
    ...
    add_sfr_register(get_eeprom()->get_reg_eeadr(), 0x191, RegisterValue(0,0), "pmadrl");
    add_sfr_register(get_eeprom()->get_reg_eeadrh(), 0x192, RegisterValue(0,0), "pmadrh");
    add_sfr_register(get_eeprom()->get_reg_eedata(),  0x193);
    add_sfr_register(get_eeprom()->get_reg_eedatah(),  0x194);
    get_eeprom()->get_reg_eecon1()->set_always_on(1<<7);
    add_sfr_register(get_eeprom()->get_reg_eecon1(),  0x195, RegisterValue(0x80,0), "pmcon1");
    add_sfr_register(get_eeprom()->get_reg_eecon2(),  0x196, RegisterValue(0,0), "pmcon2");
...
//  add_sfr_register(&pstr1con,    0x296, RegisterValue(1,0));
  ...
  add_sfr_register(&nco.nco1accl, 0x498, RegisterValue(0,0));
  add_sfr_register(&nco.nco1acch, 0x499, RegisterValue(0,0));
  add_sfr_register(&nco.nco1accu, 0x49a, RegisterValue(0,0));
  add_sfr_register(&nco.nco1incl, 0x49b, RegisterValue(1,0));
  add_sfr_register(&nco.nco1inch, 0x49c, RegisterValue(0,0));
  add_sfr_register(&nco.nco1con,  0x49e, RegisterValue(0,0));
  add_sfr_register(&nco.nco1clk,  0x49f, RegisterValue(0,0));
  ...
  add_sfr_register(&pwm1con,  0x613, RegisterValue(0,0));
  add_sfr_register(&pwm2dcl,  0x614, RegisterValue(0,0));
  add_sfr_register(&pwm2dch,  0x615, RegisterValue(0,0));
  add_sfr_register(&pwm2con,  0x616, RegisterValue(0,0));
  add_sfr_register(&pwm3dcl,  0x617, RegisterValue(0,0));
  add_sfr_register(&pwm3dch,  0x618, RegisterValue(0,0));
  add_sfr_register(&pwm3con,  0x619, RegisterValue(0,0));
  add_sfr_register(&pwm4dcl,  0x61a, RegisterValue(0,0));
  add_sfr_register(&pwm4dch,  0x61b, RegisterValue(0,0));
  add_sfr_register(&pwm4con,  0x61c, RegisterValue(0,0));

  add_sfr_register(&cwg.cwg1dbr, 0x691);
  add_sfr_register(&cwg.cwg1dbf, 0x692);
  add_sfr_register(&cwg.cwg1con0, 0x693, RegisterValue(0,0));
  add_sfr_register(&cwg.cwg1con1, 0x694);
  add_sfr_register(&cwg.cwg1con2, 0x695);

  add_sfr_register(&clcdata, 0xf0f, RegisterValue(0,0));
  add_sfr_register(&clc1.clcxcon, 0xf10, RegisterValue(0,0), "clc1con");
  ...
  add_sfr_register(&clc2.clcxcon, 0xf18, RegisterValue(0,0), "clc2con");
