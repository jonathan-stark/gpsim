...
//-------------------------------------------------------------------
void P16x71x::option_new_bits_6_7(unsigned int bits)
{
...
{
  if(verbose)
    cout << "f716 constructor, type = " << isa() << '\n';
